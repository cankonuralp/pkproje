...
(2026-09-26)**; **M3 onaylandı (2026-09-26)** (Ekipmanlar modülü kalktı, ekipmanlar planın içinde; tür başına firmanın rapor formatı PDF'i); M4 Ölçüm cihazları · Zimmetler 2. tur incelemede; genel ilke: teknik ayrıntı yok, kural uyarıdır engel değil (pkproje.md §9 on ikinci tur).
