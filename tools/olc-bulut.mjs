...
export const DENEMELER = {
  ...
  m1: [
    ...
    { ad: "zimmet formu: güncel form kartta onaylı, eskiyen uyarılı", sayfa: "maket/personel.html", hash: "#/p/mk", bekle: '/İmzalı zimmet formu yüklü: ZF-0426-003/.test(document.querySelector(".a-zimmet-form-durum").textContent)' },
