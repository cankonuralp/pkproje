...
export const DENEMELER = {
  ...
  m6: [
    ...
    { ad: "el ile ID yazılınca uyarı düşer", hash: "#/?tesis=t2", adim: [["tikla", "#p-a-ea"], ["yaz", "#p-isg-ea", "S-2026-0470"]], bekle: '!/İSG-KATİP ID\'si yok/.test(document.querySelector("#p-ozet-kap").textContent)' },
    ...
    { ad: "kapsam boş da açılır (denetçi sahada ekler)", hash: "#/?tesis=t2", adim: [["tikla", '[data-eylem="secimi-temizle"]'], ["tikla", "#p-a-mk"], ["tikla", '[data-eylem="plani-ac"]']], bekle: 'location.hash === "#/acildi" && /denetçi sahada ekler/.test(document.querySelector("#a-nesne").textContent)' },
