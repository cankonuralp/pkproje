...
export const DURUMLAR = {
  ...
  m2: { sayfa: "maket/musteriler.html", durumlar: [
    ...
    { ad: "tesis ekle · çakışan SGK tescil no uyarısı", hash: "#/m/m1/tesis-ekle", adim: [["js", 'const e = document.querySelector("#w-sgk"); e.value = MV.tesis("t1").sgk; e.dispatchEvent(new Event("input", { bubbles: true }))'], ["tikla", '[data-eylem="pencere-kaydet"]']] },
    { ad: "tesis · SGK tescil no eksik kaydedildi", hash: "#/m/m10/tesis-ekle", adim: [["yaz", "#w-ad", "Depo"], ["tikla", "#w-il"], ["tikla", '[data-secim="w-il"][data-deger="Bursa"]'], ["tikla", '[data-eylem="pencere-kaydet"]']] },
  ...
  m4: { sayfa: "maket/zimmetler.html", durumlar: [
    ...
    { ad: "cihaz · ara kontrol takip edilmiyor", sayfa: "maket/olcum-cihazlari.html", hash: "#/c/v16" },
    { ad: "cihaz düzenle", sayfa: "maket/olcum-cihazlari.html", hash: "#/c/v1", adim: [["tikla", '[data-eylem="cihaz-duzenle"]']] },
  ] },
  m5: { sayfa: "maket/sozlesmeler.html", durumlar: [
    ...
    { ad: "ID ekle · eksikten (tesis + denetçi dolu)", hash: "#/isg/yeni?tesis=t8&kisi=mk" },
    { ad: "ID ekle · boş gönderildi", hash: "#/isg/yeni?tesis=t8", adim: [["tikla", '[data-eylem="pencere-kaydet"]']] },
    { ad: "ID ekle · kişinin mevcut ID'si önceki olur uyarısı", hash: "#/isg/yeni?tesis=t12&kisi=mk" },
    { ad: "ID düzenle · PDF seçildi", hash: "#/isg/i8", adim: [["tikla", '[data-eylem="dosya-sec"]']] },
    { ad: "sözleşme şablonu", hash: "#/sablon" },
    { ad: "denetçiye göre (personel kartından)", hash: "#/isg?kisi=mk" },
  ] },
  m6: { sayfa: "maket/plan-ac.html", durumlar: [
    /* 2026-09-26 (2. tur): uyarılar engel değil; İSG-KATİP ID sözleşmeden, yoksa el ile; sahada yeni ekipman alanı kalktı */
    ...
    { ad: "ekip seçili: ID'si olmayana el ile ID alanı", hash: "#/?tesis=t2", adim: [["tikla", "#p-a-mk"], ["tikla", "#p-a-ea"]] },
    { ad: "İSG-KATİP bitmiş denetçi (uyarı)", hash: "#/?tesis=t9", adim: [["tikla", "#p-a-ea"]] },
    { ad: "açık planlı tesis: ikinci plan, aynı saat uyarısı", hash: "#/?tesis=t8", adim: [["tikla", "#p-a-mk"]] },
  ...
  m13: { sayfa: "maket/sozlesmeler.html", durumlar: [
    ...
    { ad: "sözleşme · yürürlükte, bitişe az kaldı (uyarı yok)", hash: "#/s/IS-1025-001" },
    { ad: "sözleşme · imzalı sözleşme görüntüleme", hash: "#/s/IS-1025-001/imzali" },
...
export const DENEMELER = {
  ...
  m2: [
    ...
    { ad: "tesis sayfası: Sözleşmede aç → sözleşmenin İSG-KATİP bölümü", hash: "#/t/t7", adim: [["tikla", '#a-nesne .a-alt-bas a.a-bolum-tus[href^="sozlesmeler.html"]']], bekle: '/sozlesmeler\\.html$/.test(location.pathname) && /^#\\/s\\/IS-/.test(location.hash) && !!document.querySelector("#a-b-isg")' },
    ...
    { ad: "müşteri sayfası: İş sözleşmesi yüzü → 1 / 12", hash: "#/m/m1", adim: [["tikla", 'a.a-yuz[href^="sozlesmeler.html#/?musteri"]']], bekle: '/sozlesmeler\\.html$/.test(location.pathname) && document.querySelector("#a-sayac").textContent === "1 / 12 sözleşme"' },
  ...
  m4: [
    ...
    /* 2026-09-26 (2. tur, reisim: "cihazlar eklensin tıklanınca kimde olduğu gözüksün kod verilebilsin kalibrasyon tarihi takip edilebilsin" ·
       "59 hariç dediklerini kabul ediyorum"): fotoğraf isteğe bağlı, uygulama içi onay yerine imzalı form (M1), ara kontrol isteğe bağlı */
    { ad: "teslim: kilometresiz araç teslimi reddedilir, fotoğrafsızlık yalnız uyarı", hash: "#/teslim/a3", adim: [["tikla", "#w-alan"], ["tikla", '[data-secim="w-alan"][data-deger="bs"]'], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: '/fotoğrafsız da kaydedilir/.test(document.querySelector("#a-pencere-govde").textContent) && document.querySelector("#w-km").getAttribute("aria-invalid") === "true"' },
    { ad: "teslim: fotoğrafsız teslim kaydedilir", hash: "#/teslim/d5", adim: [["tikla", "#w-alan"], ["tikla", '[data-secim="w-alan"][data-deger="ok"]'], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: 'MV.kimde("d5") === "ok" && location.hash === "#/v/d5"' },
    { ad: "teslim: kalibrasyonu geçmiş cihaz depoya alınır", hash: "#/teslim/v3", adim: [["tikla", "#w-alan"], ["tikla", '[data-secim="w-alan"][data-deger="depo"]'], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: 'location.hash === "#/v/v3" && MV.kimde("v3") === "depo" && /Depoya alındı/.test(document.querySelector(".a-gecmis").textContent)' },
    { ad: "teslim: kişiye teslim → Form imzalatılacak, uygulama içi onay yok", hash: "#/teslim/d5", adim: [["tikla", "#w-alan"], ["tikla", '[data-secim="w-alan"][data-deger="ok"]'], ["tikla", '[data-eylem="foto-ekle"]'], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: 'MV.kimde("d5") === "ok" && /Form imzalatılacak/.test(document.querySelector(".a-gecmis li").textContent) && !/Onay bekliyor/.test(document.body.textContent)' },
    { ad: "varlık sayfası: Zimmet formu → kişinin formu (Personel)", hash: "#/v/v7", adim: [["tikla", '#a-nesne .a-eylem-cubugu a[href*="zimmet-formu"]']], bekle: '/personel\\.html$/.test(location.pathname) && /zimmet-formu$/.test(location.hash)' },
    { ad: "hareketler: İmzalı formda değil çipi", hash: "#/hareketler", adim: [["tikla", '[data-cip="formsuz"]']], bekle: '/ \\/ /.test(document.querySelector("#a-sayac").textContent) && !/İmzalı formda</.test(document.querySelector("#a-liste").innerHTML)' },
    { ad: "cihaz: Kimde yüzü → zimmetteki varlık sayfası", sayfa: "maket/olcum-cihazlari.html", hash: "#/c/v7", adim: [["tikla", 'a.a-yuz[href^="zimmetler.html"]']], bekle: '/zimmetler\\.html$/.test(location.pathname) && location.hash === "#/v/v7"' },
    { ad: "cihaz: Teslim et → teslim penceresi cihazla dolu", sayfa: "maket/olcum-cihazlari.html", hash: "#/c/v1", adim: [["tikla", '#a-nesne .a-eylem-cubugu a[href*="teslim"]']], bekle: '/zimmetler\\.html$/.test(location.pathname) && document.querySelector("#a-pencere").open && /OC-001/.test(document.querySelector("#w-varlik").textContent)' },
    { ad: "cihaz: kodu düzenlenir", sayfa: "maket/olcum-cihazlari.html", hash: "#/c/v1", adim: [["tikla", '[data-eylem="cihaz-duzenle"]'], ["yaz", "#w-env", "EL-TOP-01"], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: 'MV.varlik("v1").env === "EL-TOP-01" && /EL-TOP-01/.test(document.querySelector("#a-nesne h1").textContent)' },
    { ad: "cihaz: ara kontrol takip edilmeyende bölüm yok", sayfa: "maket/olcum-cihazlari.html", hash: "#/c/v16", bekle: '!document.querySelector("#a-b-ara") && !/Sonraki ara kontrol/.test(document.querySelector("#a-nesne .a-yuzler").textContent)' },
  ...
  m5: [
    ...
    { ad: "sözleşmesi olmayan tesis → tesis sayfası", hash: "#/isg?tesis=t2", bekle: '/musteriler\\.html$/.test(location.pathname) && location.hash === "#/t/t2" && /plan açarken el ile/.test(document.querySelector("#a-nesne").textContent)' },
    { ad: "personel kartından denetçiye göre", hash: "#/isg?kisi=mk", bekle: 'MK.SZ.s.sec.kisi === "mk" && / \\/ /.test(document.querySelector("#a-sayac").textContent)' },
    { ad: "şeritteki Göster: ID'si eksik sözleşme", hash: "#/", adim: [["tikla", '[data-eylem="cip-uygula"][data-deger="ideksik"]']], bekle: '/^2 \\/ /.test(document.querySelector("#a-sayac").textContent) && /Akın Döküm/.test(document.querySelector("#a-liste").textContent) && /Ege Plastik/.test(document.querySelector("#a-liste").textContent)' },
    { ad: "İSG-KATİP bitmiş: plan gününden önce biten ID uyarılır", hash: "#/isg?tesis=t9", bekle: '/Bitmiş/.test(document.querySelector(".a-tablo-isgid").textContent) && /Elif Aydın \\(bitmiş\\)/.test(document.querySelector("#a-b-isg").closest("section").textContent)' },
    { ad: "ID düzenle: bitiş tarihi uzatılınca uyarı düşer", hash: "#/isg/i11", adim: [["yaz", "#w-bitis", "30.09.2027"], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: '!/Bitmiş/.test(document.querySelector(".a-tablo-isgid").textContent)' },
    { ad: "geç onay yalnız uyarı (kabul engellenmez)", hash: "#/isg?tesis=t7", bekle: '/Geç onay/.test(document.querySelector("#a-b-isg").closest("section").textContent) && !/kabul edemez|kabul edilemez/.test(document.body.textContent)' },
    { ad: "ID ekle: boş → denetçi ve ID hatası", hash: "#/isg/yeni?tesis=t8", adim: [["tikla", '[data-eylem="pencere-kaydet"]']], bekle: 'document.querySelectorAll(\'#a-pencere [aria-invalid="true"]\').length === 2 && document.querySelector("#a-pencere").open' },
    { ad: "ID ekle: onay tarihsiz kaydedilir, eksik düşer, planda kullanılıyor", hash: "#/isg/yeni?tesis=t8&kisi=mk", adim: [["yaz", "#w-no", "S-2026-0450"], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: 'MV.isgTesis("t8").length === 1 && !MV.isgTesis("t8")[0].onay && !/Açık planda ID/.test(document.querySelector("#a-b-isg").closest("section").textContent) && /Planda · P-0926-039/.test(document.querySelector(".a-tablo-isgid").textContent)' },
    { ad: "ID ekle: PDF'le kaydedilir", hash: "#/isg/yeni?tesis=t8&kisi=mk", adim: [["yaz", "#w-no", "S-2026-0451"], ["tikla", '[data-eylem="dosya-sec"]'], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: '/isg-katip-s-2026-0451\\.pdf/.test(document.querySelector(".a-tablo-isgid").textContent)' },
    { ad: "yenileme: kişinin eski ID'si önceki olur", hash: "#/isg/yeni?tesis=t12&kisi=mk", adim: [["yaz", "#w-no", "S-2026-0460"], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: 'MV.isgTesis("t12").filter(r => r.k === "mk").length === 1 && MV.isgTesis("t12").filter(r => r.k === "mk")[0].no === "S-2026-0460"' },
    { ad: "düzenle: onay tarihi silinebilir", hash: "#/isg/i8", adim: [["yaz", "#w-onay", ""], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: '!MV.ISG.filter(r => r.id === "i8")[0].onay && !document.querySelector("#a-pencere").open' },
    { ad: "kullanılmamış ID silinir", hash: "#/s/IS-1125-001", adim: [["tikla", '[data-eylem="isg-sil"]']], bekle: 'MV.isgTesis("t14").length + MV.isgTesis("t15").length === 1' },
    { ad: "planda kullanılan ID'de Sil yok", hash: "#/isg?tesis=t12", bekle: '!document.querySelector(\'[data-eylem="isg-sil"]\') && document.querySelectorAll(".a-tablo-isgid tbody tr").length === 2' },
    { ad: "sözleşme şablonu yüklenir", hash: "#/sablon", adim: [["tikla", '[data-eylem="dosya-sec"]'], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: 'MV.SOZ_SABLON.length === 1 && !document.querySelector("#a-pencere").open' },
  ...
  m8: [
    ...
    { ad: "sonraki kontrol gerekçeyle değişir", hash: "#/r/KP-1004", adim: [["tikla", '[data-eylem="sonraki-ac"]'], ["yaz", "#w-tarih", "23.03.2027"], ["yaz", "#w-gerekce", "Üretici altı ayda bir kontrol istiyor"], ["tikla", '[data-eylem="pencere-kaydet"]']], bekle: '/23 Mar 2027/.test(document.querySelector("#r-bk").textContent) && /Üretici altı ayda/.test(document.querySelector("#r-bk").textContent)' },
  ...
  m13: [
    { ad: "liste: 12 sözleşme, imza bekleyen üstte; hizmet sözleşmesi bitişi için şerit yok", hash: "#/", bekle: 'document.querySelector("#a-sayac").textContent === "12 sözleşme" && /IS-0926-007/.test(document.querySelector("#a-liste tbody tr").textContent) && !/bitiyor|yenileme/.test(document.querySelector("#a-uyari").textContent) && !document.querySelector(\'[data-cip="biten"]\')' },
    { ad: "imzalı sözleşme: Aç tuşu belgeyi gösterir", hash: "#/s/IS-1025-001", adim: [["tikla", '#a-nesne .a-eylem-cubugu a[href$="/imzali"]']], bekle: 'location.hash === "#/s/IS-1025-001/imzali" && !!document.querySelector(".a-belge") && /imzalı/.test(document.querySelector(".a-belge-imzalar").textContent)' },
    { ad: "imzalı sözleşme yüklenince Aç tuşu çıkar", hash: "#/s/IS-0926-007", adim: [["tikla", '[data-eylem="imzali-yukle"]']], bekle: '!!document.querySelector(\'#a-nesne .a-eylem-cubugu a[href$="/imzali"]\')' },
    ...
    { ad: "teklif sayfasından İş sözleşmesi → form teklifle dolu", sayfa: "maket/teklifler.html", hash: "#/t/T-0926-001", adim: [["tikla", '#a-nesne a[href^="sozlesmeler.html"]']], bekle: '/sozlesmeler\\.html$/.test(location.pathname) && document.querySelector("#f-teklif .a-kirp").textContent === "T-0926-001" && document.querySelector("[data-tesis=t1]").checked' },
  ...
  m6: [
    /* 2026-09-26 (2. tur, reisim: "Önerilerin uygun ama geliştirilebilir maketi yap inceleyeyim") */
    { ad: "tesisten gelince: tarih sonraki kontrol, 6 / 6 seçili", hash: "#/?tesis=t2", bekle: 'document.querySelector("#p-tarih").value === "14.10.2026" && /^6 \\/ 6 seçili/.test(document.querySelector("#p-secili").textContent)' },
    ...
    { ad: "İSG-KATİP ID sözleşmeden gelir", hash: "#/?tesis=t12", bekle: '/S-2026-0398/.test(document.querySelector("#p-a-mk").closest("tr").textContent) && !/sözleşmeden/.test(document.querySelector("#p-a-mk").closest("tr").textContent)' },
    { ad: "tarih değişince İSG uyarısı yeniden hesaplanır (odak yerinde)", hash: "#/?tesis=t7", adim: [["yaz", "#p-tarih", "30.09.2026"]], bekle: '/Uygun/.test(document.querySelector("#p-a-mk").closest("tr").textContent) && document.activeElement.id === "p-tarih"' },
    { ad: "eksikli denetçi: \"Kabul edemez\" yok, uyarı", hash: "#/?tesis=t2", adim: [["tikla", "#p-a-ea"]], bekle: '!/Kabul edemez|kabul edemez/.test(document.querySelector("#a-form-gorunum").textContent) && /uyarı/.test(document.querySelector("#p-a-ea").closest("tr").textContent)' },
    { ad: "ID'si olmayan seçilince el ile ID alanı ve sözleşmeye kaydet", hash: "#/?tesis=t4", adim: [["tikla", "#p-a-ea"]], bekle: '!!document.querySelector("#p-isg-ea") && !!document.querySelector(\'[data-kaydet="ea"]\')' },
    { ad: "el ile ID yazılınca uyarı düşer", hash: "#/?tesis=t2", adim: [["tikla", "#p-a-ea"], ["yaz", "#p-isg-ea", "S-2026-0470"]], bekle: '!/İSG-KATİP sözleşme ID\'si yok/.test(document.querySelector("#p-ozet-kap").textContent)' },
    { ad: "İSG-KATİP bitmişse uyarı (plan açılır)", hash: "#/?tesis=t9", adim: [["tikla", "#p-a-ea"]], bekle: '/bitmiş/.test(document.querySelector("#p-ozet-kap").textContent) && /Plan açılır/.test(document.querySelector("#p-ozet-kap").textContent)' },
    ...
    { ad: "saat değişince çakışma kalkar", hash: "#/?tesis=t8", adim: [["tikla", "#p-a-mk"], ["yaz", "#p-bas", "13:00"], ["yaz", "#p-bit", "15:00"]], bekle: '!/aynı saatte/.test(document.querySelector("#p-ozet-kap").textContent)' },
    { ad: "açık plandaki ekipman seçilemez; ikinci plan bilgisi", hash: "#/?tesis=t8", bekle: '[...document.querySelectorAll("[data-ekp]")].every(e => e.disabled) && /İkinci plan açılabilir/.test(document.querySelector("#a-form-gorunum").textContent)' },
    { ad: "sahada yeni ekipman alanı yok; Hepsini seç", hash: "#/?tesis=t12", adim: [["tikla", '[data-eylem="secimi-temizle"]'], ["tikla", '[data-eylem="hepsini-sec"]']], bekle: '!document.querySelector("#p-yeniTur") && /^24 \\/ 24 seçili/.test(document.querySelector("#p-secili").textContent)' },
    { ad: "kapsam boş da açılır", hash: "#/?tesis=t2", adim: [["tikla", '[data-eylem="secimi-temizle"]'], ["tikla", "#p-a-mk"], ["tikla", '[data-eylem="plani-ac"]']], bekle: 'location.hash === "#/acildi" && /Kapsam\\s*Boş/.test(document.querySelector("#a-nesne").textContent)' },
    ...
    { ad: "plan açılır: el ile ID sözleşmeye kaydedilir", hash: "#/?tesis=t4", adim: [["tikla", "#p-a-mk"], ["tikla", "#p-a-ea"], ["yaz", "#p-isg-ea", "S-2026-0470"], ["tikla", '[data-kaydet="ea"]'], ["tikla", '[data-eylem="plani-ac"]']], bekle: 'location.hash === "#/acildi" && /P-0926-040/.test(document.querySelector("#a-nesne h1").textContent) && /sözleşmesine de kaydedildi/.test(document.querySelector("#a-nesne").textContent) && MV.isgTesis("t4").some(r => r.no === "S-2026-0470")' },
    { ad: "Ana sayfa (planlama): Plan aç tuşu", sayfa: "maket/anasayfa.html", hash: "#/planlama", adim: [["tikla", '.a-sayfa-bas a[href^="plan-ac.html"]']], bekle: '/plan-ac\\.html$/.test(location.pathname)' },
