...
export const DENEMELER = {
  ...
  m5: [
    ...
    { ad: "şeritteki Göster: ID'si eksik sözleşme", hash: "#/", adim: [["tikla", '[data-eylem="cip-uygula"][data-deger="ideksik"]']], bekle: '/^1 \\/ /.test(document.querySelector("#a-sayac").textContent) && /Akın Döküm/.test(document.querySelector("#a-liste").textContent)' },
